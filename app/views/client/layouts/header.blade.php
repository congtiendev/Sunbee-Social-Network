                ...
                <div class="header_widgets">
                    ...
                    <div uk-drop="mode: click" class="header_dropdown dropdown_cart">
                        <div class="drop_headline">
                            <h4> Giỏ hàng</h4>
                            <a href="#" class="px-2 py-1 mr-2 underline rounded-md btn_action hover:bg-gray-100">
                                Thanh toán </a>
                        </div>
                                ...
                                <li class="not-read">
                                    <a href="#">
                                        <div class="drop_avatar status-online"> <img
                                                src="{{ IMG_PATH }}avatars/avatar-2.jpg" alt="">
                                        </div>
                                        <div class="drop_text">
                                            <p>
                    ...
                    <div uk-drop="mode: click;offset:5" class="header_dropdown profile_dropdown">
                        <a href="#" class="user flex items-center">
                            <div class="user_avatar">
                                <img class="is_avatar object-cover"
