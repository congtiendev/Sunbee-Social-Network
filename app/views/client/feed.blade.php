...
@section('content')
                                    ...
                                    <div class="p-2 options-post">
                                        ...
                                        <div class="hidden w-56 p-2 mx-auto mt-12 text-base text-gray-500 bg-white border border-gray-100 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700"
                                            ...
                                            <ul class="space-y-1">
                                                ...
                                                <li>
                                                    <a data-post-id="{{ $post->post_id }}"
                                                        data-user-id="{{ $user->id }}"
                                                        href="{{ route('posts/delete/' . $post->post_id) }}"
                                                        class="flex items-center px-3 py-2 text-red-500 rounded-md hover:bg-red-100 hover:text-red-500 dark:hover:bg-red-600 delete__post-btn">
                            ...
                            {{ $post->post_content }}
                                ...
                                <div class="flex items-center justify-between px-5 py-3 border-t border-gray-100">
                                    <div class="flex gap-5">
                                        <svg data-post-id="{{ $post->post_id }}"
                                            ...
                                            class="w-6 h-6 fill-black dark:fill-white like__post-btn like__post-btn-{{ $post->post_id }}  @if ($post->is_liked) active @endif"
                                    ...
                                    <svg data-post-id="{{ $post->post_id }}" data-user-id="{{ $_SESSION['auth']->id }}"
                                        class="w-6 h-6 save__post-btn  save__post-btn-{{ $post->post_id }} fill-black dark:fill-white"
                                        viewBox="0 0 48 48">
                                        <path
                                ...
                                @if ($post->comment_count > 0)
                                    ...
                                    <div class="mb-0.5 text-sm text-[#737373] dark:text-gray-400 comment__post px-5">
                                        <a href="#post__detail-{{ $post->post_id }}">
                                            Xem <span
                                                class="comment__post-count-{{ $post->post_id }}">{{ intval($post->comment_count) }}</span>
                                            bình luận
                                        </a>
                                    </div>
                                @else
                                ...
                                <form method="post" id="add__comment-{{ $post->post_id }}"
                                    ...
                                    <span class="absolute inset-y-0 right-0 flex items-center gap-2 pr-7 md:gap-3">
                                        ...
                                        <button data-post-id="{{ $post->post_id }}" data-user-id="{{ $user->id }}"
                                            type="submit" class="focus:outline-none focus:shadow-none btn__add-comment">
                                ...
                                <!-- ---------------------------POSTS DETAIL------------------------------ -->
                                <div id="post__detail-{{ $post->post_id }}"
                                    ...
                                    <div class="bg-white uk-modal-dialog dark:bg-gray-900">
                                        ...
                                        <div class="w-full mx-auto sm:max-w-3xl md:max-w-full lg:max-w-screen-xl">
                                            <div class="@if (count($post->medias) > 0) grid md:grid-cols-2 @endif">
                                                <div>
                                                    ...
                                                    <section
                                                        ...
                                                        <div uk-lightbox class=" swiper-wrapper">
                                                            @foreach ($post->medias as $media)
                                                                <div
                                                                    class="flex items-center bg-white w-fit swiper-slide ">
                                                                    <a href="{{ POST_MEDIA_PATH . $media->post_media }}">
                                                                        @if (isImage($media->post_media))
                                                                            <img src="{{ POST_MEDIA_PATH . $media->post_media }}"
                                                                                alt="Mở ảnh"
                                                ...
                                                <section
                                                    class="  flex flex-col max-h-[500px] details__posts justify-between">
                                                    <!-- --------------------------------AUTHOR INFO--------------------------------- -->
                                                    <div class="relative flex flex-col overflow-y-auto hidden__scrollbar">
                                                        <div class="flex items-center gap-2 px-5 py-2 author">
                                                            ...
                                                            <div class="author__name">
                                                                <a href="#"
                                                                    class="text-sm text-[#262626] dark:text-white font-semibold">{{ $post->first_name . ' ' . $post->last_name }}</a>
                                                ...
                                                {{ $post->post_content }}
                                                        ...
                                                        <section
                                                            ...
                                                            <div class="pb-2 text-sm font-semibold like__post">
                                                                <span
                                                                    class="like__post-count-{{ $post->post_id }}">{{ $post->like_count }}</span>
                                                                lượt thích
                                                            </div>
                                                            <div class="pb-2 text-sm font-semibold share__post">
                                                                <span
                                                                    class="share__post-count-{{ $post->post_id }}">{{ $post->share_count }}</span>
                                                                chia sẻ
                                                            </div>
                                                        </section>
                                                        ...
                                                        <section
                                                            ...
                                                            @if ($post->comment_count < 1)
                                                                <div id="no__comment-{{ $post->post_id }}"
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                adipisicing
                                                                                elit. Voluptate animi expedita hic.
                                                                                Voluptates nemo
                                                                                id ad ipsa alias repellat consequatur
                                                                                inventore
                                                                                nobis asperiores doloribus ea, quisquam
                                                                                dolores
                                                    ...
                                                    <form method="post" id="add__comment-{{ $post->post_id }}"
                                                        ...
                                                        <img class="object-cover w-10 h-10 mr-2 rounded-full shadow cursor-pointer"
                                                            alt="User avatar" src="{{ AVATAR_PATH . $user->avatar }}">
                                                        <span
                                                            class="absolute inset-y-0 right-0 flex items-center gap-2 pr-5 md:gap-3">
                                                            <svg class="w-6 h-6 text-gray-400 transition duration-300 ease-out hover:text-yellow-500"
                                                            ...
                                                            <label for="comment__media-1" class="mt-1.5">
                                                                <input data-post-id="1" id="comment__media-1"
                                                                    type="file" name="comment_media"
                                                                    class="sr-only comment__media"
                                                                    accept="image/*,video/*" />
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                    viewBox="0 0 24 24" stroke-width="1.5"
                                                                    stroke="currentColor"
                                                        ...
                                                        <input type="search"
                                                            ...
                                                            style="border-radius: 25px" placeholder="Nhập bình luận ..."
                                                            autocomplete="off">
                                                    </form>
                                                </section>
                                            </div>
    ...
    <div id="create-post-modal" class="create-post is-story" uk-modal>
        <form data-user-id="{{ $user->id }}" method="post" id="create-post" enctype="multipart/form-data"
            class="p-0 rounded-lg shadow-2xl uk-modal-dialog uk-modal-body uk-margin-auto-vertical lg:w-5/12 uk-animation-slide-bottom-small">
            ...
            <div class="flex items-start flex-1 p-5 space-x-4 user">
                ...
                <div class="flex-1 pt-2">
                    <textarea id="post_content"
                        ...
                        rows="5" name="post_content" placeholder="{{ $user->last_name }} ơi, bạn đang nghĩ gì thế  ?"></textarea>
                </div>
            </div>
                ...
                <div class="flex items-center p-2 border border-purple-100 shadow-sm bg-gray-50 rounded-2xl">
                    ...
                    <div class="flex items-center justify-end flex-1 space-x-2">
                        ...
                        <div class="dropdown dropdown-top dropdown-end">
                            <label tabindex="0"><img src="{{ IMG_PATH }}icon/tag-icon.png"
                                    class="h-auto w-11"></label>
                            <ul tabindex="0"
                        ...
                        <div class="dropdown dropdown-top dropdown-end">
                            <label tabindex="0"><img src="{{ IMG_PATH }}icon/feelings.png"
                                    class="w-10 h-auto "></label>
                            <div tabindex="0"
        ...
        <div class="story-sidebar uk-animation-slide-left-medium">
            ...
            <div class="story-sidebar-scrollbar" data-simplebar>
                ...
                <a class="items-center hidden py-2 space-x-4 rounded-lg md:flex hover:bg-gray-100 md:my-2 hover:text-gray-700"
                    href="#">
                    <svg class="w-12 h-12 p-3 ml-1 text-blue-500 bg-gray-200 rounded-full" fill="none"
            ...
            <div class="space-y-6">
                <div class="pb-2 space-y-6 sm:space-y-8">
                    ...
                    <div class="flex items-center space-x-3 sm:space-x-6">
                        <img src="{{ IMG_PATH }}avatars/avatar-3.jpg" alt=""
                            class="rounded-full sm:w-16 sm:h-16 w-14 h-14">
                        <div class="flex-1">
                ...
                <div class="relative cursor-pointer"
                    uk-toggle="target: .upcoming__birthday; animation: uk-animation-fade">
