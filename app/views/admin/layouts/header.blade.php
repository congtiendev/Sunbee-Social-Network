     ...
     <div class="flex items-center justify-between flex-grow px-4 py-4 shadow-2 md:px-6 2xl:px-11">
         <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
             ...
             <a class="flex-shrink-0 block lg:hidden" href="index.html">
                 <img class="h-5" src="{{ IMG_PATH . 'logo/logo.png' }}" alt="Logo" />
             </a>
         </div>
                 ...
                 <section class="relative">
                     <button class="absolute left-0 -translate-y-1/2 top-1/2">
                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="w-6 h-6 hover:fill-primary dark:hover:fill-primary">
             ...
             <ul class="flex items-center gap-2 2xsm:gap-4">
                 ...
                 <li class="relative" x-data="{ dropdownOpen: false, notifying: true }">
                     <a class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
                         ...
                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="w-5 h-5 duration-300 ease-in-out">
                             <path stroke-linecap="round" stroke-linejoin="round"
                             ...
                             <li class="relative">
                                 <a class="flex items-center gap-2.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                     ...
                                     <img class="object-cover object-center w-10 h-10 rounded-full"
                                         src="{{ BASE_URL }}public/uploads/avatar/64306b3724f935.49531392-73299304_713050679162551_5255345154734161920_n.jpg"
                                         alt="" />
                                 ...
                                 <section
                                     ...
                                     <label tabindex="0" class=""><svg xmlns="http://www.w3.org/2000/svg"
                                     ...
                                     <ul tabindex="0"
                                         ...
                                         <li class="flex items-center justify-between">
                                             <a>Đánh dấu là đã xem</a><svg xmlns="http://www.w3.org/2000/svg"
                 ...
                 <li class="relative" x-data="{ dropdownOpen: false, notifying: true }">
                     <a class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
                         ...
                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                             stroke-width="1.5" stroke="currentColor" class="w-5 h-5 duration-300 ease-in-out">
                             <path stroke-linecap="round" stroke-linejoin="round"
                             ...
                             <li class="relative">
                                 <a class="flex items-center gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                     ...
                                     <div class="h-12 w-12 rounded-full relative">
                                         <img class="avatar w-full h-full rounded-full"
                                             src="{{ BASE_URL }}public/uploads/avatar/643148434a3b63.61528062-AVT.jpg"
                                             alt="User" />
                                         <span
                                             class="status bg-green-500 w-3 h-3 border-2 border-white rounded-full absolute bottom-0 right-1"></span>
                                     </div>
                                     <div class="messages__content">
                                         <h6 class="fullname text-sm font-medium text-black dark:text-white">
                                             Lê Công Tiến
                                         </h6>
                                 ...
                                 <section
                                     ...
                                     <ul tabindex="0"
                                         ...
                                         <!-- ---------------------------------------------------- -->
                                         <li class="flex items-center justify-between">
                                             <a>Báo cáo</a><svg xmlns="http://www.w3.org/2000/svg" fill="none"
             ...
             <section class="relative" x-data="{ dropdownOpen: false }">
                 <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                     <section class="hidden text-right lg:block">
                         <span class="fullname block text-sm font-medium text-black dark:text-white">
                             {{ $_SESSION['auth']->first_name . ' ' . $_SESSION['auth']->last_name }}
                         </span>
                         <span class="username block text-xs font-medium">
                     ...
                     <div class="avatar w-12 h-12 rounded-full">
                         <img class="avatar w-full h-full rounded-full"
                             src="{{ empty($_SESSION['auth']->avatar) ? AVATAR_PATH . 'default-avatar.jpg' : AVATAR_PATH . $_SESSION['auth']->avatar }}"
                             alt="avatar" />
                     </div>
                 ...
                 <section x-show="dropdownOpen"
                     ...
                     <ul
                         class="flex flex-col text-sm text-gray-700 gap-3 border-b border-stroke p-5 dark:border-strokedark">
                         @if (isset($_SESSION['auth']) && !empty($_SESSION['auth']))
                             <li>
                                 <a href="{{ 'admin/profile/' . $_SESSION['auth']->id }}"
                             ...
                             <li>
                                 <a href="{{ 'admin/update-profile/' . $_SESSION['auth']->id }}"
                                     class="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                         <path stroke-linecap="round" stroke-linejoin="round"
                             ...
                             <li>
                                 <a href="{{ 'logout' }}"
                                     class="flex items-center gap-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
