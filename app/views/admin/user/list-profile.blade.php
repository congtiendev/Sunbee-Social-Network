    ...
    <main class="w-full h-full p-2 overflow-y-auto sm:p-5 rounded-2xl hidden__scrollbar">
        ...
        <div class="flex items-center justify-between mb-1 title__list-user">
            ...
            <section class="flex items-center gap-2 mb-3">
                <form class="flex gap-2 fillter__accounts item-center" action="{{ route('sort-profile') }}" method="POST">
                    <select id="countries" name="sort_profile"
                    ...
                    <button type="submit" name="sort_profile_btn" data-te-ripple-init data-te-ripple-color="light"
