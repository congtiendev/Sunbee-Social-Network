							...
							<tr>
								<th scope="col"
									...
									<div class="flex items-center gap-x-3 focus:outline-none">
										<span>Tên</span>
										<a
												href="{{ !empty($keyword) ? route('admin/search-profile/' . $keyword . '/first_name/ASC') : route('admin/list-profile/first_name/ASC') }}">
								...
								<th scope="col"
									...
									<div class="flex items-center gap-x-3 focus:outline-none">
										<a
												href="{{ !empty($keyword) ? route('admin/search-profile/' . $keyword . '/birthday/ASC') : route('admin/list-profile/birthday/ASC') }}">
											<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
										...
										<span>Ngày sinh</span>
										<a
												href="{{ !empty($keyword) ? route('admin/search-profile/' . $keyword . '/birthday/DESC') : route('admin/list-profile/birthday/DESC') }}">
											<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
											     stroke-width="1.5" stroke="currentColor"
								...
								<tr>
									...
									<td class="py-4 pr-5 text-sm text-center whitespace-nowrap">
										<p class="text-gray-700 dark:text-white">
											{{ isset($user->birthday) ? date('d/m/Y', strtotime($user->birthday)) :
											'Trống' }}
										</p>
									</td>
									...
									<td class="px-4 py-4 text-sm whitespace-nowrap">
										<div class="dropdown dropdown-left dropdown-end">
											...
											<ul tabindex="0"
												...
												<li class="flex items-center justify-between gap-3">
													<a href="{{ route('admin/update-profile/' . $user->id) }}"
