...
@section('content')
    <main class="w-full h-full overflow-y-auto p-2 sm:p-5 rounded-2xl hidden__scrollbar">
        ...
        <div class="flex items-center justify-between mb-1 title__list-user">
            <!-- ----------------------Title account------------------------ -->
            <h2 class="flex items-center pb-1 gap-2 sm:gap-3 text-xs font-semibold sm:text-lg">
                <img class="w-6 h-6" src="./resources/images/list-icon.png" alt="" />
                Danh sách tài khoản
            </h2>
            <!-- --------------------Fillter account---------------------- -->
            <section class="flex items-center gap-2 mb-3">
                <form class="flex gap-2 fillter__accounts item-center" action="" method="post">
                    <select id="countries"
                            class="block w-full sm:p-2 p-1 text-xs text-gray-900 rounded-md bg-white border focus:ring-blue-500 focus:border-blue-500dark:focus:border-blue-500 focus:outline-indigo-500">
                    ...
                    <button name="btn-fill-account" data-te-ripple-init data-te-ripple-color="light"
        ...
        <section class="w-full overflow-x-auto">
            <!-- ------------------------list account---------------------- -->
            <table class="list-accoumt w-full overflow-hidden whitespace-no-wrap bg-white border rounded-t-lg">
                ...
                <tr class="hover:bg-gray-100">
                        ...
                        <div class="flex items-center">
                            <div class="hidden mr-3 rounded-full w-9 h-9 md:block">
                                <img class="object-cover w-full h-full rounded-full"
                                     src="./resources/images/default-avatar.jpg" alt="" loading="lazy" />
                            </div>
                            <div>
                                <p class="font-semibold text-sm text-gray-700 whitespace-nowrap full__name">
                    ...
                    <td class="px-4 py-3 text-xs sm:text-sm email text-gray-700 whitespace-nowrap">
                       {{$user->email}}
                    </td>
                    ...
                    <td class="px-4 py-3 text-xs sm:text-sm text-white whitespace-nowrap">
                    <span
                        ...
                        <section class="flex items-center justify-center">
                            <div class="flex justify-center">
                                <div class="relative" data-te-dropdown-position="dropstart">
                                    <button class="rounded-full motion-reduce:transition-none md:hidden hover:bg-gray-200"
                                            type="button" id="dropdownMenuButton1s" data-te-dropdown-toggle-ref aria-expanded="false"
                                            data-te-ripple-init>
                                        <img class="w-7 h-7" src="./resources/images/opiton-menu-icon.png" alt="" />
                                    </button>
                                    <ul
                                            class="absolute p-2 z-[1000] float-left m-0 hidden min-w-max list-none
                                        ...
                                        <li class="mb-2">
                                            <a class="flex items-center w-full gap-2 bg-transparent whitespace-nowrap hover:bg-neutral-100 active:text-neutral-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent"
                                               href="{{route('update-account/'.$user->id)}}" data-te-dropdown-item-ref>Chỉnh sửa
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                                     class="w-3 h-3 text-gray-400">
                                                    <path
                                        ...
                                        <li>
                                            <a data-id="{{$user->id}}" class="flex items-center w-full gap-2
                                            bg-transparent
                                            whitespace-nowrap hover:bg-neutral-100 active:text-neutral-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent"
                            ...
                            <section class="items-center hidden gap-2 text-xs crud__user-pc md:flex">
                                <a href="" class="flex items-center">
                                    <img class="min-w-5 min-h-5 max-w-5 max-h-5" src="./resources/images/detail-btn.png"
                                         alt="" />
                                </a>
                                <a href="{{route('update-account/'.$user->id)}}" class="flex items-center">
                                    <img class="min-w-5 min-h-5 max-w-5 max-h-5" src="./resources/images/edit-btn.png"
                                         alt="" />
                                </a>
                                <a data-id="{{$user->id}}" href="{{route('delete-account/'.$user->id)}}"
                                   class="delete-account flex
                                items-center">
                                    <img class="min-w-5 min-h-5 max-w-5 max-h-5" src="./resources/images/delete-btn.png"
                                         alt="" />
                                </a>
                            </section>
                        </section>
        ...
        <!-- Phân trang -->
        <section
                class="grid rounded-b-lg px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t sm:grid-cols-9 bg-white">
            <span class="flex items-center col-span-3 text-xs whitespace-nowrap">
              Hiển thị 1 đến 10 trong 57 bản ghi
            </span>
