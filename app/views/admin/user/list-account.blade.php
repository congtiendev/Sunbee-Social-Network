                                ...
                                <tr>
                                    <th scope="col"
                                        ...
                                        <div class="flex items-center gap-x-3 focus:outline-none">
                                            <span>Tên</span>
                                            <a
                                                href="{{ !empty($keyword) ? route('admin/search-account/' . $keyword . '/first_name/ASC') : route('admin/account/list/first_name/ASC') }}">
                                    ...
                                    <th scope="col"
                                        ...
                                        <div class="flex items-center gap-x-3 focus:outline-none">
                                            <a
                                                href="{{ !empty($keyword) ? route('admin/search-account/' . $keyword . '/created_at/ASC') : route('admin/account/list/created_at/ASC') }}">
                                            ...
                                            <span>Ngày tạo</span>
                                            <a
                                                href="{{ !empty($keyword) ? route('admin/search-account/' . $keyword . '/created_at/DESC') : route('admin/account/list/created_at/DESC') }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor"
                                        ...
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <div class="dropdown dropdown-left dropdown-end">
                                                ...
                                                <ul tabindex="0"
                                                    ...
                                                    <li class="flex items-center justify-between gap-3">
                                                        <a href="{{ route('admin/account/update/' . $user->id) }}"
