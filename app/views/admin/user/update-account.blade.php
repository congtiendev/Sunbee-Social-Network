            ...
            <article class="w-full h-full px-4 py-3 bg-white shadow-xs sm:px-5 sm:py-3">
                <section class="w-full h-full setting-user-info">
                    <form action="{{ route('save-update-account/' . $user->id) }}" method="post" class="w-full h-full">
                        <h1 class="my-4 text-xl font-semibold text-gray-700">Cập nhật
                            tài khoản
                        </h1>
                        <div class="grid grid-cols-1 gap-5 form-control sm:grid-cols-2">
                            <div class="form-group">
                                ...
                                <span class="mt-2 text-xs text-red-500">
                                    {{ !empty($errors['first_name']) ? $errors['first_name'] : '' }}
                                </span>
                            </div>
                            <div class="form-group">
                                ...
                                <span class="mt-2 text-xs text-red-500">
                                    {{ !empty($errors['last_name']) ? $errors['last_name'] : '' }}
                                </span>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="relative flex items-center mt-2">
                                    ...
                                    <input type="text" placeholder="Username..." name="username"
                                        class="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5   focus:border-indigo-400 focus:ring-indborder-indigo-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                        value="@if (!empty($user->username)) {{ $user->username }}@else{{ $_POST['username'] ?? '' }} @endif">
                                </div>
                                <span class="mt-2 text-xs text-red-500">
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative flex items-center mt-2">
                                    ...
                                    <input type="email" placeholder="Email..." name="email"
                                        class="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5   focus:border-indigo-400 focus:ring-indborder-indigo-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                        value="{{ !empty($user->email) ? $user->email : $_POST['email'] ?? '' }}">
                                </div>
                                <span class="mt-2 text-xs text-red-500">
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative flex items-center mt-2">
                                    ...
                                    <input type="number" min="0" placeholder="Số điện thoại..."
                                        name="phone_number"
                                        class="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5   focus:border-indigo-400 focus:ring-indborder-indigo-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                        value="{{ !empty($user->phone_number) ? $user->phone_number : $_POST['phone_number'] ?? '' }}">
                                </div>
                                <span class="mt-2 text-xs text-red-500">
                                    {{ !empty($errors['phone_number']) ? $errors['phone_number'] : '' }}
                                </span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('change-password') }}" class="btn btn-outline btn-info">Đổi mật
                                    khẩu</a>
                            </div>
                        </div>
