        ...
        <div class="modal modal-bottom sm:modal-middle">
            <div class="modal-box bg-slate-50 dark:bg-base-100 hidden__scrollbar">
                ...
                <form id="create__post-form" method="post" enctype="multipart/form-data">
                    ...
                    <pre id="post__content-preview"
                        class="text-[#000000] font-montserrat text-start dark:text-gray-100"></pre>
                    <div id="post__media-preview" class="grid  grid-cols-2 gap-1"></div>
                ...
                <section id="post-action_{{ $post->post_id }}">
                    ...
                    <section class="my-2 text-[#000000] text-sm total-interact dark:text-white">
                        ...
                        <div class=" text-sm text-[#737373] dark:text-gray-400 comment__post">
                            ...
                            <a href="#">
                                Xem <span class="comment__post-count">{{ intval($post->comment_count) }}</span>
                                bình luận
                            </a>
                            @else
                                    ...
                                    <section class="  flex flex-col max-h-[500px] details__posts justify-between">
                                        ...
                                        <section id="details__post-action_{{ $post->post_id }}" class="p-4">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <svg data-post-id="{{ $post->post_id }}"
                                                    data-user-id="{{ $_SESSION['auth']->id }}"
                                                    class="save__details-post-btn w-6 h-6 fill-black dark:fill-white @if ($post->is_saved) active @endif"
                                                    viewBox="0 0 48 48">
                                                    <path
                                                        d="M43.5 48c-.4 0-.8-.2-1.1-.4L24 29 5.6 47.6c-.4.4-1.1.6-1.6.3-.6-.2-1-.8-1-1.4v-45C3 .7 3.7 0 4.5 0h39c.8 0 1.5.7 1.5 1.5v45c0 .6-.4 1.2-.9 1.4-.2.1-.4.1-.6.1zM24 26c.8 0 1.6.3 2.2.9l15.8 16V3H6v39.9l15.8-16c.6-.6 1.4-.9 2.2-.9z">
                                                    </path>
                                            ...
                                            <section class="my-2 text-[#000000] total-interact dark:text-white">
                                                <div class="text-sm pb-2 font-semibold like__post">
                                                ...
                                                <div id="add__comment_{{ $post->post_id }}"
                                                    ...
                                                    <label for="comment_media_{{ $post->post_id }}">
                                                        <input id="comment_media_{{ $post->post_id }}" type="file"
                                                            name="comment_media[]" class="sr-only comment_media"
                                                            accept="image/*,video/*" />
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                    ...
                                                    <input id="comment_content_{{ $post->post_id }}" type="text"
                                                    ...
                                                    <button data-post-id="{{ $post->post_id }}"
                                                        data-user-id="{{ $_SESSION['auth']->id }}"
                                                        class="add__comment-btn text-sm font-semibold text-blue-500 dark:text-white absolute right-0 ">
                                                        Đăng
                                                    </button>
                                                </div>
                                            </section>
